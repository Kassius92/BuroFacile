...
export const metadata = {
  ...
  description: 'Termini di Servizio di BuroSemplice: natura delle informazioni, scheda personalizzata, limitazioni di responsabilità e condizioni d\'uso.',
    ...
    <>
      ...
      <div className="page-wrap">
        ...
        <div className="prose">
          ...
          <p>BuroSemplice offre inoltre un servizio gratuito di <strong>scheda personalizzata</strong>: l&apos;utente compila un form con i propri dati e riceve via email una scheda con importi, bonus, uffici e scadenze calcolati sulla propria situazione.</p>
          ...
          <p>Le guide e i contenuti di BuroSemplice — comprese le schede personalizzate — sono redatti con cura e aggiornati periodicamente, ma hanno carattere <strong>puramente informativo e orientativo</strong>. In particolare:</p>
          <ul>
          ...
          <p>La scheda personalizzata è generata sulla base dei dati forniti dall&apos;utente. BuroSemplice non è responsabile per errori derivanti da dati incompleti o inesatti inseriti nel form.</p>

          <h2>4. Contatto con professionisti terzi</h2>
          <p>Se l&apos;utente presta il consenso esplicito, BuroSemplice può condividere i suoi dati con professionisti selezionati (commercialisti, consulenti fiscali, mediatori creditizi, geometri, agenti immobiliari, consulenti del lavoro) affinché possano contattarlo con proposte pertinenti.</p>
          <p>BuroSemplice seleziona i professionisti con ragionevole cura, ma <strong>non garantisce</strong> la qualità, la competenza o l&apos;esito del servizio offerto da professionisti terzi. L&apos;eventuale rapporto tra l&apos;utente e il professionista è un rapporto diretto tra le due parti, del quale BuroSemplice non è parte.</p>
          <p>L&apos;utente può revocare il consenso al contatto da parte di professionisti in qualsiasi momento scrivendo a <a href="mailto:info.burosemplice@gmail.com">info.burosemplice@gmail.com</a>.</p>
          ...
          <p>Le guide contengono link a siti istituzionali e di terze parti (es. agenziaentrate.gov.it, inps.it). Alcune guide contengono link di affiliazione: se acquisti tramite questi link, BuroSemplice riceve una commissione. Questo non comporta alcun costo aggiuntivo per te e non influenza il contenuto delle guide.</p>
          <p>BuroSemplice non è responsabile del contenuto di siti esterni e non ne garantisce l&apos;aggiornamento o la disponibilità.</p>
