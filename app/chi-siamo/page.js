        ...
        <div className="prose">
          ...
          <div className="values">
            <div className="val">
              ...
              <div className="val-text">Le guide sono complete al 100%. Non tagliamo il contenuto per spingere all&apos;acquisto. Chi legge sa tutto quello che deve sapere.</div>
            </div>
            <div className="val">
              <div className="val-icon">✅</div>
