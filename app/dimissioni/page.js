...
export default function Page() {
  ...
  return (
    <>
      ...
      <div className="layout">
        <main className="main">
          ...
          <div className="ctabanner r">
            ...
            <a href="/ordina?scheda=dimissioni" className="btnc">Personalizza per me — Gratis</a>
          </div>
        ...
        <aside className="aside">
          <div className="sb-cta">
            <div className="sb-ct">Preavviso e TFR personalizzati</div>
            <div className="sb-cd">Calcolo esatto per il tuo CCNL e la tua situazione.</div>
            <a href="/ordina?scheda=dimissioni" className="sb-cb">Personalizza — Gratis</a>
          </div>
          <div className="sbsec">
      ...
      <StickyBar scheda="dimissioni" />
      <ExitPopup scheda="dimissioni" />
