...
export default function Page() {
  ...
  return (
    <>
      ...
      <div className="layout">
        <main className="main">
          ...
          <div className="ctabanner r">
            ...
            <a href="/ordina?scheda=mi-sposo" className="btnc">Personalizza per me — Gratis</a>
          </div>
        ...
        <aside className="aside">
          <div className="sb-cta">
            <div className="sb-ct">Checklist matrimonio personalizzata</div>
            <div className="sb-cd">Documenti, scadenze e costi per la tua situazione.</div>
            <a href="/ordina?scheda=mi-sposo" className="sb-cb">Personalizza — Gratis</a>
          </div>
          <div className="sbsec">
      ...
      <StickyBar scheda="mi-sposo" />
      <ExitPopup scheda="mi-sposo" />
