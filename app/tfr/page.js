...
export default function Page() {
  ...
  return (
    <>
      ...
      <div className="layout">
        <main className="main">
          ...
          <div className="sec r" id="calcolo">
            ...
            <CalcTfr />
            <BlurredRow label="Il tuo TFR netto esatto" />
          ...
          <div className="ctabanner r">
            ...
            <a href="/ordina?scheda=tfr" className="btnc">Personalizza per me — Gratis</a>
          </div>
        ...
        <aside className="aside">
          <div className="sb-cta">
            <div className="sb-ct">Calcolo TFR personalizzato</div>
            <div className="sb-cd">Importo netto esatto con la tua RAL e anzianità.</div>
            <a href="/ordina?scheda=tfr" className="sb-cb">Personalizza — Gratis</a>
          </div>
          <div className="sbsec">
      ...
      <StickyBar scheda="tfr" />
      <ExitPopup scheda="tfr" />
