...
export default function Page() {
  ...
  return (
    <>
      ...
      <div className="layout">
        <main className="main">
          ...
          <div className="ctabanner r">
            ...
            <p>Ti calcoliamo l&apos;importo preciso della NASpI nella tua situazione, con le scadenze da rispettare e i bonus a cui hai diritto.</p>
            <a href="/ordina?scheda=naspi" className="btnc">Personalizza per me — Gratis</a>
          </div>
        ...
        <aside className="aside">
          <div className="sb-cta">
            <div className="sb-ct">Calcolo personalizzato NASpI</div>
            <div className="sb-cd">Importo preciso, durata e scadenze nella tua situazione.</div>
            <a href="/ordina?scheda=naspi" className="sb-cb">Personalizza — Gratis</a>
          </div>
          <div className="sbsec">
      ...
      <StickyBar scheda="naspi" />
      <ExitPopup scheda="naspi" />
