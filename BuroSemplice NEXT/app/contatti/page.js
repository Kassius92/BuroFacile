...
export const metadata = {
  title: 'Contatti — BuroSemplice',
  description: 'Contatta BuroSemplice: hai trovato un errore, vuoi suggerire una guida o hai una domanda? Rispondiamo entro 24 ore.',
  alternates: { canonical: 'https://burosemplice.it/contatti' },
  openGraph: {
    title: 'Contatti — BuroSemplice',
    description: 'Contatta BuroSemplice: hai trovato un errore, vuoi suggerire una guida o hai una domanda? Rispondiamo entro 24 ore.',
    url: 'https://burosemplice.it/contatti',
  },
};
    ...
    <>
      ...
      <div className="page-wrap">
        ...
        <div className="contact-grid">
          <a href="mailto:info.burosemplice@gmail.com" className="contact-card">
            <div className="contact-icon">✉️</div>
            <div className="contact-type">Email generale</div>
            <div className="contact-value">info.burosemplice@gmail.com</div>
        ...
        <div className="faq-section">
          <h2>Domande frequenti su BuroSemplice</h2>

          <div className="faq-item">
            <div className="faq-q">Posso fidarmi delle informazioni di BuroSemplice?</div>
            <div className="faq-a">Le guide sono scritte a partire da fonti ufficiali (Agenzia delle Entrate, INPS, testi di legge) e aggiornate quando cambia la normativa. Ogni scheda indica le fonti di riferimento. Detto questo, BuroSemplice non è un consulente professionale: per decisioni importanti, verifica sempre con un commercialista o un CAF.</div>
          </div>
          ...
          <div className="faq-item">
            ...
            <div className="faq-a">Scrivici a <a href="mailto:info.burosemplice@gmail.com">info.burosemplice@gmail.com</a> indicando la scheda, la sezione e l&apos;errore che hai trovato. Verifichiamo e correggiamo entro 24 ore. Grazie — ci aiuti a tenere le guide accurate.</div>
          </div>

          <div className="faq-item">
            <div className="faq-q">Posso usare il contenuto di BuroSemplice sul mio sito?</div>
            <div className="faq-a">Puoi citare brevi estratti con link alla fonte. Non è consentita la riproduzione integrale dei testi. Per usi editoriali o collaborazioni scrivi a <a href="mailto:info.burosemplice@gmail.com">info.burosemplice@gmail.com</a>.</div>
          </div>

          <div className="faq-item">
            <div className="faq-q">BuroSemplice può rispondere a domande sulla mia situazione specifica?</div>
