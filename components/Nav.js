        ...
        <div className="nav-i">
          ...
          {variant === 'home' && (
            <>
              ...
              <Link href="/" className="logo"><div className="logo-mark">Z</div><div className="logo-text">Zero<span>Burocrazia</span><small className="logo-sub">La burocrazia, finalmente zero</small></div></Link>
