        ...
        <div className="nav-i">
          ...
          {variant === 'home' && (
            <>
              ...
              <Link href="/" className="logo"><div className="logo-mark">B</div><div className="logo-text">Buro<span>Semplice</span><small className="logo-sub">La burocrazia semplice</small></div></Link>
